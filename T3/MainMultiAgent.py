    ...
    for run in tqdm(range(num_runs), desc="Running Q-Learning on HunterEnv"):
        ...
        for episode in range(num_episodes):
            ...
            while not done:
                ...
                hunter1.update(state, action_hunter1, reward1, next_sate, single_agent_action_space, done)
                hunter2.update(state, action_hunter2, reward2, next_sate, single_agent_action_space, done)
                prey.update(state, action_prey, reward3, next_sate, single_agent_action_space, done)
